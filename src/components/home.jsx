...
const Homepage = () => {
  return (
    <>
<section className="sticky top-0 flex flex-col-reverse lg:flex-row items-center min-h-screen bg-black py-[10rem] lg:py-0 text-white px-6 md:px-12 lg:px-20">
        <div className="flex flex-col items-start w-full lg:w-1/2 lg:pl-[9rem]">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            <a
              href="#hire-me"
              className="bg-gradient-to-r tracking-widest from-blue-500 to-purple-500 text-black font-semibold py-2 px-6 rounded-full hover:from-blue-600 hover:to-purple-600 transition duration-300"
            >
              SAY HELLO👋
            </a>
            <a
              href="#my-works"
              className="border border-gray-300 text-gray-300 font-semibold py-2 px-6 rounded-full hover:border-white hover:text-white transition duration-300"
            >
              My Works
            </a>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end lg:items-start mb-8 lg:mb-0 pr-0 lg:pr-[5rem] pb-0 lg:pb-[12rem]">
        <img
  src={img}
  alt="Sangik Ghosh"
