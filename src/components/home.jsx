...
const Homepage = () => {
  return (
    <>
      <section className="sticky top-0 flex flex-col-reverse lg:flex-row items-center min-h-screen bg-black py-[10rem] lg:py-0 text-white px-6 md:px-12 lg:px-0 xl:px-14">
