...
const Homepage = () => {
  return (
    <>
      <section className="home mt-[-10rem] lg:mt-0 flex flex-col-reverse lg:flex-row items-center min-h-[50vh] bg-black py-[1rem] lg:py-0 text-white px-6 md:px-12 lg:px-0 xl:px-14">
