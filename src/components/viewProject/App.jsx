...
export default function AnimatedModalDemo() {
  ...
  return (
    <div className="py-2 flex items-center justify-center bg-black">
      <Modal>
...
const VacationIcon = PlaneIcon;
const ElevatorIcon = PlaneIcon;
const FoodIcon = PlaneIcon;
const MicIcon = PlaneIcon;
const ParachuteIcon = PlaneIcon;
