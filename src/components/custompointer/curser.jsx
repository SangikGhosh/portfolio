  ...
  return (
    (<motion.div
      ...
      <svg
        ...
        strokeWidth="1"
        viewBox="0 0 16 16"
        className="h-6 w-6 text-sky-500 bg-transparent transform -rotate-[70deg] -translate-x-[12px] -translate-y-[10px] stroke-sky-600"
        height="1em"
        width="1em"
      ...
      <motion.div
        ...
        className={
          "px-2 py-2 bg-neutral-200 text-white whitespace-nowrap min-w-max text-xl rounded-full"
        }>
        {title || `Sangik Ghosh`}
      </motion.div>
    </motion.div>)
